<div class="flex justify-center lg:-mx-12 my-12 p-6 md:px-12 bg-grey-50 border border-grey-400 text-sm md:rounded shadow">
    ...
    <form action="{{ $page->appUrl }}/newsletter/subscribe" method="POST" accept-charset="utf-8">
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="cf-turnstile mt-4" data-sitekey="{{ $page->turnstileNewsletterSiteKey }}" data-action="newsletter"></div>

            <input type="submit" value="Update Me!" class="shrink-0 mt-4 bg-white text-sm cursor-pointer text-indigo-500 py-2 px-4 rounded-full font-bold shadow" data-umami-event="newsletter-submit" data-umami-event-source="newsletter-form-blog">
        </div>
    </form>
</div>
